...
const Play = () => {
  ...
  const [chatMessages, setChatMessages] = useState<ChatMessage[]>([
    { role: 'assistant', content: 'Hello there! I am Piyush Arun 👋 Ask me anything you want to know!' }
  ]);
  ...
  return (
    <div className="play-page">
      ...
      <div className="play-header">
        <Link to="/#cta" className="back-button" data-cursor="disable">
          ← Back to Home
        </Link>
      </div>
          ...
          <div className="chat-header">
            <div className="chat-header-user">
              <div className="chat-avatar-header">
                <img src="/images/mypic.png" alt="Piyush Avatar" />
              </div>
              <span className="chat-title">Talk with Piyush</span>
            </div>
          </div>
          ...
          <div className="player-bar opponent-bar">
            <div className="player-info">
              ...
              <div className="player-details">
                <span className="player-name">Piyush</span>
